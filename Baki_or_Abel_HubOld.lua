                    ...
                    if
                        v.Name ~= game.Players.LocalPlayer.Name and not BlackList[v.Name] and
                            ...
                            (v.Character.HumanoidRootPart.Position -
                                game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 17000 and
                                        ...
                                        if
                                         ...
                                         then
                                            PlayerTargetedCFrame =
                                                v.Character.HumanoidRootPart.CFrame * CFrame.new(0, 7, 0)
                                        ...
                                        if
                                         ...
                                         then
                                            ...
                                            (v.Character.HumanoidRootPart.Position -
                                                ...
                                                100
                                         then
                                            ToggleSkill:Set(false)
                                            ToggleSpamGun:Set(false)
                                            ToggleSpamSword:Set(false)
                                            ToggleSpamDF:Set(false)
                                            ToggleSpamMelee:Set(false)
                                            UseFastAttack = false
                                            autospamskill = false
                                            AimbotDiThangNgu = false
                                        end
...
ToggleSkill =
            ck:AddToggle({Name = "Auto Spam Skill", Default = h["Auto Spam Skill"], Callback = function(bm)
            autospamskill = bm
...
function CheckItem2(ah)
    for k, v in pairs(game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("getInventory"))Soul Gui do
        if v.Name == ah then
            return v.Name .. " "
        end
    end
